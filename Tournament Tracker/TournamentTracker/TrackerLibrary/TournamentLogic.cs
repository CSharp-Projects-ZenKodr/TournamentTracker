...
namespace TrackerLibrary {
    public static class TournamentLogic {
        ...
        // Check if list is big enought, if not add in byes, need 2^n of teams
        // Create our first round of matchups
        // Create every round after that, if have 8 matchups, we''l then have 4, then 2, then 1
        ...
        public static void AlertUsersToNewRound (this TournamentModel model) {
            int currRoundNum = model.CheckCurrentRound();
        ...
        private static int CheckCurrentRound (this TournamentModel model) {
            ...
            foreach (List<MatchupModel> round in model.Rounds) {
                //if all of the items match the criteria we give it, returns true
        ...
        private static List<TeamModel> RandomizeTeamOrder (List<TeamModel> teams) {
            //exampleList.OrderBy(a => Guid.NewGuid()).ToList();
